  ...
  <v-app :style="{ background: $vuetify.theme.themes.dark.background }">
    ...
    <v-container>
      <v-toolbar flat color="transparent">
        ...
        <v-text-field
          label="Search here"
          class="pt-5 mb-2 d-none d-sm-flex"
          dark
          filled
      ...
      <p class="grey--text">
        A Greet Way To Generate All the Motivation You Need To Get Fit
      </p>
      <v-app-bar dark color="transparent" flat>
        <v-tabs color="#6f0Dff">
          <v-tabs-slider color="#6f0dff"></v-tabs-slider>
          <v-tab class="withoutupercase">Fultillment Srarus Views</v-tab>
      ...
      <v-toolbar color="transparent" class="mt-n4" flat>
      ...
      <v-row class="mt-n10">
        <v-col cols="12" xs="12" sm="6" md="4" lg="3" v-for="(order,i) in orders" :key="i">
          <v-card class="mx-auto mt-12 rounded-lg" max-width="374" color="#151515">
...
<script>
import RightSidbar from "@/components/RightSidbar.vue";
